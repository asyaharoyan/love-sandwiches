...
def validate_data(values):
    ...
    or if there aren't ecatly 6 values
    """
    print(values)
    try:
...
def update_worksheet(data, worksheet):
    """
     ...
     Update the relevant worksheet tish the data prvided
    """
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure substructed from the stock:
    -Positive surplis indicate waste
    -Negative surplis indicate extra made
    """
...
def calculate_stock_data(data):
    """"
    calculating the average stock data for each item type, adding 10%
    """
...
print("Welcome to Love Sandwiches Data Aytomation")
main()
